...
""").format(config["DWH_SCHEMA"]["MODEL_SCH"],config["DWH_TABLES"]["APP_FACT_FT"])
...
""").format(config["DWH_SCHEMA"]["MODEL_SCH"],config["DWH_TABLES"]["APP_CATEGORY_DM"])
...
""").format(config["DWH_SCHEMA"]["MODEL_SCH"],config["DWH_TABLES"]["CURRENCY_TYPE_DM"])
...
""").format(config["DWH_SCHEMA"]["MODEL_SCH"],config["DWH_TABLES"]["DEVELOPER_DM"])
...
""").format(config["DWH_SCHEMA"]["MODEL_SCH"],config["DWH_TABLES"]["CONTENT_RATING_DM"])
...
""").format(config["DWH_SCHEMA"]["MODEL_SCH"],config["DWH_TABLES"]["PERMISSION_TYPE_DM"])
